...
from gym.wrappers.frame_stack import LazyFrames as GymLazyFrames
...
def get_args(cfg: DictConfig):
    ...
    cfg.device = "mps" if torch.backends.mps.is_built() else cfg.device
...
def main(cfg: DictConfig):
    args = get_args(cfg)
    wandb.init(project=args.project_name, entity='itaibear',
    ...
    if isinstance(state_0[0], (LazyFrames, GymLazyFrames)):
    ...
    for epoch in count():
        ...
        for episode_step in range(EPISODE_STEPS):
            ...
            if learn_steps % args.env.eval_interval == 0:
                ...
                logger.log('eval/timesteps', timesteps, learn_steps)
                ...
                if timesteps > longest_eval_timesteps:
                    best_eval_returns = timesteps
                    wandb.run.summary["longest_eval"] = timesteps
                    save(agent, epoch, args, output_dir='results_longest')
        ...
        logger.log('train/episode_steps', episode_steps, learn_steps)
