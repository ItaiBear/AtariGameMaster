...
class TetrisQNetwork(SoftQNetwork):
    def __init__(self, obs_dim, action_dim, args, device='cpu', input_dim=(20, 10)):
        super(TetrisQNetwork, self).__init__(obs_dim, action_dim, args, device)
...
class TetrisQNetwork3(SoftQNetwork):
    def __init__(self, obs_dim, action_dim, args, device='cpu', input_dim=(20, 10)):
        super(TetrisQNetwork3, self).__init__(obs_dim, action_dim, args, device)
        print("input_dim: ", input_dim)
        print("obs_dim: ", obs_dim)
        self.frames = 4
        self.n_outputs = action_dim
        ...
        # CNN modeled off of Mnih et al.
        self.cnn = nn.Sequential(
            nn.Conv2d(self.frames, 32, kernel_size=3, stride=1),
            nn.ReLU(),
...
class TetrisQNetwork2(SoftQNetwork):
    def __init__(self, obs_dim, action_dim, args, device='cpu', input_dim=(20, 10)):
        super(TetrisQNetwork2, self).__init__(obs_dim, action_dim, args, device)
        print("input_dim: ", input_dim)
        print("obs_dim: ", obs_dim)
        self.frames = 4
        self.n_outputs = action_dim
...
class TetrisQNetwork4(SoftQNetwork):
    def __init__(self, obs_dim, action_dim, args, device='cpu', input_dim=(20, 10)):
        super(TetrisQNetwork4, self).__init__(obs_dim, action_dim, args, device)
        print("input_dim: ", input_dim)
        print("obs_dim: ", obs_dim)
        self.frames = 4
        self.n_outputs = action_dim
...
class TetrisQNetwork5(SoftQNetwork):
    def __init__(self, obs_dim, action_dim, args, device='cpu', input_dim=(20, 10)):
        super(TetrisQNetwork5, self).__init__(obs_dim, action_dim, args, device)
        print("input_dim: ", input_dim)
        print("obs_dim: ", obs_dim)
        self.frames = 4
        self.n_outputs = action_dim
        ...
        # CNN modeled off of Mnih et al.
        self.cnn = nn.Sequential(
            nn.Conv2d(self.frames, 32, kernel_size=3, stride=1, padding=1),
            nn.ReLU(),
            nn.Conv2d(32, 64, kernel_size=2, stride=1),
            nn.ReLU(),
        )
...
# Small network
class SmallQNetwork(SoftQNetwork):
    def __init__(self, obs_dim, action_dim, args, device='cpu'):
        super(SmallQNetwork, self).__init__(obs_dim, action_dim, args, device)
        frame_stack = 4
